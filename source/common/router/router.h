...
public:
  FilterConfig(const std::string& stat_prefix, const LocalInfo::LocalInfo& local_info,
               ...
               TimeSource& time_source, Http::Context& http_context, const std::string& color_cookie_name,
      ...
      : scope_(scope), local_info_(local_info), cm_(cm), runtime_(runtime),
        ...
        color_cookie_name_(color_cookie_name),is_send_proxy_protocol_(is_send_proxy_protocol) {}
  ...
  FilterConfig(const std::string& stat_prefix, Server::Configuration::FactoryContext& context,
      ...
      : FilterConfig(stat_prefix, context.localInfo(), context.scope(), context.clusterManager(),
                     ...
                     context.api().timeSource(), context.httpContext(),config.color_cookie_name(),
  ...
  const std::string& getColorCookieName() const { return color_cookie_name_; }
