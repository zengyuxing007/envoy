...
public:
  ...
  template <typename T1, typename T2> inline Table setRawTable(const T1&, const T2&);
  template <typename T1, typename T2> inline bool getRawTable(Table&, T1&, T2&);
  template <typename T1, typename T2, typename T3>
  inline Table setRawTable(const T1&, const T2&, const T3&);
  template <typename T1, typename T2, typename T3> inline bool getRawTable(Table&, T1&, T2&, T3&);
  template <typename T1, typename T2, typename T3, typename T4>
  inline Table setRawTable(const T1&, const T2&, const T3&, const T4&);
  template <typename T1, typename T2, typename T3, typename T4>
  inline bool getRawTable(Table&, T1&, T2&, T3&, T4&);
  template <typename T,
            template <typename E, typename = std::less<E>, typename = std::allocator<E>> class Cont>
  ...
  template <typename T1, typename T2,
            template <typename E1, typename E2, typename = std::less<E1>,
                      typename = std::allocator<std::pair<const E1, E2>>>
            class Cont>
